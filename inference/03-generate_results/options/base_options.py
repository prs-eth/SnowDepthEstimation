...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', type=str, default='../data', help='path to data folder')
        parser.add_argument('--name', type=str, default='experiment_name', help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints', help='models are saved here')
        # model parameters
        parser.add_argument('--model', type=str, default='yeti_v3', help='chooses which model to use. [yeti_v1 | ...]')
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='yeti_v5', help='chooses how datasets are loaded. [yeti_v1 | ...]')
